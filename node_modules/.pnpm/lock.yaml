...
packages:
  ...
  /css-parse/1.7.0:
    resolution: {integrity: sha1-Mh9s9zeCpv91ERE5D8BeLGV9jJs=}
    dev: false
  ...
  /hexo-log/3.0.0:
    resolution: {integrity: sha512-fd87qXYznpNTa8SLov+wjDsrPssk4yKSgdIQg1wJPcuthy8ngvbXYdqaJ4vWMSADZ+D257EmKXTJHJyaxJQhVw==}
    engines: {node: '>=12.4.0'}
    dependencies:
      nanocolors: 0.2.13
    dev: false
  ...
  /hexo-renderer-stylus/2.0.1:
    resolution: {integrity: sha512-1S4AG8RtzWqVrqKIYv2AJ4UYms5SHDjkdYS7IiGwgUejL24agbTktpAbnH2cG1JWZ15SRqYN0UGB9aAoSAgvEA==}
    engines: {node: '>=10.13.0'}
    dependencies:
      nib: 1.1.2
      stylus: 0.54.8
  ...
  /hexo-util/2.6.0:
    resolution: {integrity: sha512-sLG45foxXMnMgCo3FpP4Sicj5nLD6ezO46+DKP01BWj1CfNq2pYoUdJacfeVbKc+oFtitRcNIGsPNNt3pVbzdg==}
    engines: {node: '>=12.4.0'}
    dependencies:
      bluebird: 3.7.2
      camel-case: 4.1.2
  ...
  /hexo/6.1.0:
    resolution: {integrity: sha512-TeV2cN61CD2C1GKczJRR3tdZhR3JUQi8wtS4eIgkDOeDYWTmovPoSCcc8jvh42D3fehOPp6E81fTeyjh39QWtA==}
    engines: {node: '>=12.13.0'}
    hasBin: true
    dependencies:
      abbrev: 1.1.1
  ...
  /nib/1.1.2:
    resolution: {integrity: sha1-amnt5AgblcDe+L4CSkyK4MLLtsc=}
    dependencies:
      stylus: 0.54.5
    transitivePeerDependencies:
      - supports-color
  ...
  /stylus/0.54.5:
    resolution: {integrity: sha1-QrlWCTHKcJDOhRWnmLqeaqPW3Hk=}
    hasBin: true
    dependencies:
      css-parse: 1.7.0
      debug: 4.3.4
  ...
  /warehouse/4.0.0:
    resolution: {integrity: sha512-9i6/JiHzjnyene5Pvvl2D2Pd18no129YGy0C0P7x18iTz/SeO9nOBioR64XoCy5xKwBKQtl3MU361qpr0V9uXw==}
    engines: {node: '>=10.13.0'}
    dependencies:
      bluebird: 3.7.2
      cuid: 2.1.8
